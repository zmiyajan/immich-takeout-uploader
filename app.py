...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .meta2{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:5px}
  ...
  <section class="step" id="s3">
    ...
    <div class="opt"><input type="checkbox" id="syncAlbums" checked>
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--sync-albums</code><span class="lbl" data-i18n="n_needs"></span><code class="tiny">album.read</code> <code class="tiny">album.create</code> <code class="tiny">albumAsset.create</code></div>
    ...
    <div class="opt"><input type="checkbox" id="peopleTag" checked>
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--people-tag</code><span class="lbl" data-i18n="n_needs"></span><code class="tiny">tag.create</code> <code class="tiny">tag.asset</code></div>
    ...
    <div class="opt"><input type="checkbox" id="takeoutTag" checked>
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--takeout-tag</code><span class="lbl" data-i18n="n_needs"></span><code class="tiny">tag.create</code> <code class="tiny">tag.asset</code></div>
    ...
    <div class="opt"><input type="checkbox" id="continueOnError" checked>
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--on-errors=continue</code></div>
      ...
      <div class="inner">
        <div class="opt"><input type="checkbox" id="includeArchived" checked>
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--include-archived</code></div>
        ...
        <div class="opt"><input type="checkbox" id="includePartner" checked>
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--include-partner</code></div>
        ...
        <div class="opt"><input type="checkbox" id="includeUntitled">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--include-untitled-albums</code></div>
        ...
        <div class="opt"><input type="checkbox" id="includeTrashed">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--include-trashed</code></div>
        ...
        <div class="opt"><input type="checkbox" id="includeUnmatched">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--include-unmatched</code></div>
        ...
        <div class="cols" style="margin-top:13px">
          ...
          <div class="field"><label><span data-i18n="l_album"></span><button type="button" class="i" data-help="hf-h_fromAlbum-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_fromAlbum-1" data-i18n-html="h_fromAlbum" style="margin-bottom:8px"></div>
            <input type="text" id="fromAlbum" placeholder="--from-album-name"></div>
        </div>
        <div class="cols">
          <div class="field"><label><span data-i18n="l_incext"></span><button type="button" class="i" data-help="hf-h_extensions-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_extensions-1" data-i18n-html="h_extensions" style="margin-bottom:8px"></div>
            <input type="text" id="includeExt" placeholder=".jpg,.heic"></div>
          <div class="field"><label><span data-i18n="l_excext"></span><button type="button" class="i" data-help="hf-h_extensions-2" aria-expanded="false">i</button></label><div class="help" id="hf-h_extensions-2" data-i18n-html="h_extensions" style="margin-bottom:8px"></div>
            <input type="text" id="excludeExt" placeholder=".gif,.mp"></div>
        </div>
        <div class="field"><label><span data-i18n="l_daterange"></span><button type="button" class="i" data-help="hf-h_dateRange-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_dateRange-1" data-i18n-html="h_dateRange" style="margin-bottom:8px"></div>
    ...
    <details class="grp">
      ...
      <div class="inner">
        ...
        <div class="cols">
          <div class="field"><label><span data-i18n="l_rawjpeg"></span><button type="button" class="i" data-help="hf-h_pairs-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_pairs-1" data-i18n-html="h_pairs" style="margin-bottom:8px"></div>
          ...
          <div class="field"><label><span data-i18n="l_heicjpeg"></span><button type="button" class="i" data-help="hf-h_pairs-2" aria-expanded="false">i</button></label><div class="help" id="hf-h_pairs-2" data-i18n-html="h_pairs" style="margin-bottom:8px"></div>
        ...
        <div class="field"><label><span data-i18n="l_burst"></span><button type="button" class="i" data-help="hf-h_burst-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_burst-1" data-i18n-html="h_burst" style="margin-bottom:8px"></div>
        ...
        <div class="opt"><input type="checkbox" id="epsonFastFoto">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--manage-epson-fastfoto</code></div>
      ...
      <div class="inner">
        <div class="opt"><input type="checkbox" id="sessionTag">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--session-tag</code><span class="lbl" data-i18n="n_needs"></span><code class="tiny">tag.create</code> <code class="tiny">tag.asset</code></div>
        ...
        <div class="field"><label><span data-i18n="l_partneralbum"></span><button type="button" class="i" data-help="hf-h_partnerAlbum-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_partnerAlbum-1" data-i18n-html="h_partnerAlbum" style="margin-bottom:8px"></div>
    ...
    <details class="grp">
      ...
      <div class="inner">
        <div class="cols" style="margin-top:13px">
          <div class="field"><label><span data-i18n="l_conc"></span><button type="button" class="i" data-help="hf-h_concurrent-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_concurrent-1" data-i18n-html="h_concurrent" style="margin-bottom:8px"></div>
            <input type="number" id="concurrent" value="6" min="1" max="20">
            <p class="hintline" data-i18n-html="d_conc"></p></div>
          <div class="field"><label><span data-i18n="l_timeout"></span><button type="button" class="i" data-help="hf-h_clientTimeout-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_clientTimeout-1" data-i18n-html="h_clientTimeout" style="margin-bottom:8px"></div>
            <input type="text" id="clientTimeout" placeholder="20m">
            <p class="hintline" data-i18n-html="d_timeout"></p></div>
        </div>
        <div class="field"><label><span data-i18n="l_tz"></span><button type="button" class="i" data-help="hf-h_timeZone-1" aria-expanded="false">i</button></label><div class="help" id="hf-h_timeZone-1" data-i18n-html="h_timeZone" style="margin-bottom:8px"></div>
        ...
        <div class="opt"><input type="checkbox" id="overwrite">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--overwrite</code><span class="lbl" data-i18n="n_needs"></span><code class="tiny">asset.delete</code></div>
        ...
        <div class="opt"><input type="checkbox" id="skipVerifySSL">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--skip-verify-ssl</code></div>
        ...
        <div class="opt"><input type="checkbox" id="apiTrace">
          <div class="body">
            ...
            <div class="meta2"><span class="lbl" data-i18n="n_flag"></span><code class="tiny">--api-trace</code></div>
